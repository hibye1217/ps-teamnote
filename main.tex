...
\end{minted}
\subsection{\toadd{Gauss-Jordan Elimination}}
...
\end{minted}
\subsection{\torevise{Minimum Enclosing Circle}}
\begin{minted}{cpp}
...
\end{minted}
\section{Greedy}
\subsection{\toadd{Job Scheduling w/ Deadline \& Duration}}
\section{Heuristics}
...
\end{minted}
\subsection{\totest{Bitwise Function}}
\begin{minted}{cpp}
